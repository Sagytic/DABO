...
//        }
    ...
    public List<CampaignDto> getAllCampaign() {
        ...
        // Optimization: findAllByOrderByCampaignIdDesc uses @EntityGraph to fetch users in one query (preventing N+1)
        // and performs sorting in the database instead of in-memory.
    ...
    public List<CampaignDto> getUrgentCampaign() {
        ...
        // Optimization: findAllByOrderByDeadLineAsc uses @EntityGraph to fetch users in one query (preventing N+1)
        // and performs sorting in the database, replacing inefficient manual sorting.
